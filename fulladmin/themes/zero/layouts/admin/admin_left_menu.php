 ...
 ?>
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <?php } ?>
         ...
         <li>
              <a href="<?= Yii::getAlias('@web') ?>/admin/contact/index?type=info">
              
                <i class="fa fa-envelope"></i> <span><?= Yii::t('app', 'CONTACT INFO')?></span> <span class="badge"><?= $setting->countNewContactInfo ?></span>
              </a>
        	</li>
        	
        	 <li>
              <a href="<?= Yii::getAlias('@web') ?>/admin/contact/index?type=service">
              
                <i class="fa fa-envelope"></i> <span><?= Yii::t('app', 'CONTACT SERVICES')?></span> <span class="badge"><?= $setting->countNewContactService ?></span>
              </a>
        	</li>	
