<?php 
/**
 * layout for page in anhduong theme
 */
...
<title>Về chúng tôi - Công ty TNHH trang trí nội thất Ánh Dương</title>
<?php $this->head() ?>
...
<meta property="og:title" content="Về chúng tôi - Công ty TNHH trang trí nội thất Ánh Dương />
...
<meta name="twitter:title" content="Về chúng tôi - Công ty TNHH trang trí nội thất Ánh Dương" />
...
<div id="page" >
    ...
    <?= $this->render('page-header-single') ?>
    <?= $this->render('content-single') ?>
