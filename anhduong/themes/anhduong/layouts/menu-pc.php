  <div class="masthead inline-header center widgets full-height small-mobile-menu-icon dt-parent-menu-clickable"  role="banner">
    ...
    <header class="header-bar">
      ...
      <ul id="primary-menu" class="main-nav underline-decoration l-to-r-line outside-item-remove-margin" role="navigation">
        ...
        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-329 has-children"><a href='#' data-level='1'><span class="menu-item-text"><span class="menu-text">SẢN PHẨM</span></span></a>
          <ul class="sub-nav gradient-hover hover-style-bg level-arrows-on">
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-412 first"><a href='/site2/product/' data-level='2'><span class="menu-item-text"><span class="menu-text">Tấm ốp</span></span></a></li>
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-413"><a href='/site2/product/' data-level='2'><span class="menu-item-text"><span class="menu-text">Trần kim loại</span></span></a></li>
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-411"><a href='/site2/product/' data-level='2'><span class="menu-item-text"><span class="menu-text">Cửa Inox</span></span></a></li>
          </ul>
        </li>
        
         <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-329 has-children"><a href='#' data-level='1'><span class="menu-item-text"><span class="menu-text">THIẾT KẾ & THI CÔNG</span></span></a>
          <ul class="sub-nav gradient-hover hover-style-bg level-arrows-on">
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-412 first"><a href='/site2/page/' data-level='2'><span class="menu-item-text"><span class="menu-text">Thiết kế</span></span></a></li>
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-413"><a href='/site2/page/' data-level='2'><span class="menu-item-text"><span class="menu-text">Thi công</span></span></a></li>
            <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-411"><a href='/site2/page/' data-level='2'><span class="menu-item-text"><span class="menu-text">Vật liệu</span></span></a></li>
          </ul>
        </li>
        
        
        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-330"><a href='/site2/page/' data-level='1'><span class="menu-item-text"><span class="menu-text">DỰ ÁN</span></span></a></li>
        
        <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-330"><a href='/site2/page/' data-level='1'><span class="menu-item-text"><span class="menu-text">TUYỂN DỤNG</span></span></a></li>
        
        <!-- <li class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-65 has-children"><a href='#' data-level='1'><span class="menu-item-text"><span class="menu-text">TIN TỨC</span></span></a>
          <ul class="sub-nav gradient-hover hover-style-bg level-arrows-on">
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-204 first"><a href='https://savimec.vn/tin-tuc/' data-level='2'><span class="menu-item-text"><span class="menu-text">Tin tức</span></span></a></li>
            <li class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-779"><a href='https://savimec.vn/category/tuyen-dung/' data-level='2'><span class="menu-item-text"><span class="menu-text">Tuyển dụng</span></span></a></li>
          </ul>
        </li> -->
