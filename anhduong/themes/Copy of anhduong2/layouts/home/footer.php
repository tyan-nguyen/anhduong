  ...
  <div class="corp-container">
    <div class="widgets widgets-5" aria-label="Footer Widgets">
      <aside id="nav_menu-8" class="widget widget_nav_menu">
        <div class="menu-main-footer-menu-container">
          <ul id="menu-main-footer-menu" class="menu">
            <li id="menu-item-17098" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-17098"><a href="https://www.aperam.com/stainless/what-is-stainless-steel/">Stainless</a></li>
      ...
      <aside id="nav_menu-4" class="widget widget_nav_menu">
        <div class="menu-top-bar-container">
          <ul id="menu-top-bar-1" class="menu">
            <li class="menu-item menu-item-type-post_type menu-item-object-page menu-item-46"><a href="https://www.aperam.com/documentation/">Documentation</a></li>
      ...
      <aside id="nav_menu-6" class="widget widget_nav_menu">
        <h2 class="widget-title">Our websites <i class="fa-solid fa-chevron-down"></i></h2>
        <div class="menu-our-websites-container">
          <ul id="menu-our-websites" class="menu">
            <li id="menu-item-71" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-71"><a href="https://www.aperam.com/sitemap/">Sitemap</a></li>
      ...
      <aside id="sow-social-media-buttons-4" class="widget widget_sow-social-media-buttons">
        <div
			
			class="so-widget-sow-social-media-buttons so-widget-sow-social-media-buttons-wire-df3bebaba07e"
			
		>
          <div class="social-media-button-container"> <a class="ow-button-hover sow-social-media-button-linkedin-0 sow-social-media-button" title="aperam on Linkedin" aria-label="aperam on Linkedin" target="_blank" rel="noopener noreferrer" href="https://www.linkedin.com/company/aperam" > <i class="fa-brands fa-linkedin-in"></i> </a> <a class="ow-button-hover sow-social-media-button-youtube-0 sow-social-media-button" title="aperam on Youtube" aria-label="aperam on Youtube" target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/channel/UCQSu0MKC5vQi9h_sbfzo2CQ" > <i class="fa-brands fa-youtube"></i> </a> </div>
        </div>
      </aside>
    </div>
  </div>
